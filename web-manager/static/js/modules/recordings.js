            ...
            if (data.success) {
                ...
                if (maxQuotaEl) {
                    if (data.storage_info?.max_disk_enabled) {
                        let quotaClass = '';
                        let quotaIcon = 'fa-database';
                        if (data.storage_info.quota_exceeded) {
                            quotaClass = 'quota-exceeded';
                            quotaIcon = 'fa-exclamation-triangle';
                        } else if (data.storage_info.quota_warning) {
