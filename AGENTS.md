...
├── rpi_av_rtsp_recorder.sh           # Script RTSP principal (v2.12.2) - Dispatcheur USB/CSI
├── rpi_csi_rtsp_server.py            # Serveur RTSP CSI natif (v1.4.11) - Picamera2 + GStreamer
